...
//        // :size in "to drawSquare :size" — line 0, col 14, len 5, type=parameter(4), mod=0
//        assertToken(2, 0, 11, 5, 4, 2);
//        // :size in "to shrinkingSquares :size" — line 6, col 20, len 5, type=parameter(4), mod=0
//        assertToken(12, 0, 17, 5, 4, 2);
//    }
//
//    @Test
